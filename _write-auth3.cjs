...
// The entire file content encoded as a JS string using ES6 template literal
// Using .replace to handle backticks inside JSX
const content = [
  '"use client";',
  '',
  ...
  '        )}',
  '',
  '        <div className="w-full max-w-[1100px] min-h-[700px] flex flex-col md:flex-row rounded-[32px] overflow-hidden" style={{ backgroundColor: "#ffffff", boxShadow: "0 4px 12px rgba(0, 0, 0, 0.04)", border: "1px solid rgba(193, 201, 190, 0.2)" }}>',
  '',
  '          {/* Left: Brand Identity */}',
  '          <section className="hidden md:flex flex-1 flex-col items-center justify-center relative overflow-hidden px-12" style={{ backgroundColor: "#fcfaeb" }}>',
  ...
  '',
  '          {/* Right: Auth Form */}',
  '          <section className="flex-1 flex flex-col justify-center px-8 md:px-16 py-12" style={{ backgroundColor: "#ffffff" }}>',
  '            <div className="w-full max-w-md mx-auto">',
  '',
  '              <div className="md:hidden mb-6"><Logo width={128} height={40} /></div>',
  '',
  '              <div className="mb-10">',
  '                <h1 style={{ fontFamily: "\'Plus Jakarta Sans\', sans-serif", fontSize: isSignup ? "32px" : "48px", lineHeight: isSignup ? "40px" : "56px", letterSpacing: "-0.02em", fontWeight: 700, color: "#1c1c13" }}>{isSignup ? "Create Account" : "Login"}</h1>',
  '                <p className="mt-2" style={{ fontFamily: "\'Plus Jakarta Sans\', sans-serif", fontSize: "16px", lineHeight: "24px", fontWeight: 400, color: "#424941" }}>{isSignup ? "Join the community today." : "Please enter your credentials to access your account."}</p>',
  '              </div>',
  '',
  ...
  '                )}',
  '',
  '                <button type="submit" disabled={!!loadingText} className="w-full py-4 rounded-xl font-semibold flex items-center justify-center gap-2 transition-all disabled:opacity-50" style={{ fontFamily: "\'Plus Jakarta Sans\', sans-serif", fontSize: "24px", lineHeight: "32px", fontWeight: 600, backgroundColor: "#325b38", color: "#ffffff", boxShadow: "0 8px 16px rgba(50, 91, 56, 0.1)" }} onMouseEnter={(e) => { if (!loadingText) e.currentTarget.style.backgroundColor = "#264f2e"; }} onMouseLeave={(e) => { if (!loadingText) e.currentTarget.style.backgroundColor = "#325b38"; }}>',
  '                {loadingText || (isSignup ? "Create Account" : "Sign In")}',
  '                {!loadingText && <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></svg>}',
  '              </button>',
  '',
  '              <div className="relative py-4 flex items-center gap-4">',
  '                <div className="flex-grow" style={{ borderTop: "1px solid rgba(193, 201, 190, 0.3)" }} />',
  '                <span style={{ fontFamily: "\'Plus Jakarta Sans\', sans-serif", fontSize: "14px", lineHeight: "20px", letterSpacing: "0.05em", fontWeight: 500, color: "rgba(114, 121, 112, 0.6)", textTransform: "uppercase" }}>or continue with</span>',
  '                <div className="flex-grow" style={{ borderTop: "1px solid rgba(193, 201, 190, 0.3)" }} />',
  '              </div>',
  '',
  '              <div className="grid grid-cols-2 gap-4">',
  '                <button type="button" onClick={handleGoogleLogin} disabled={!!loadingText} className="flex items-center justify-center gap-2 py-3 rounded-xl transition-colors disabled:opacity-50" style={{ fontFamily: "\'Plus Jakarta Sans\', sans-serif", fontSize: "14px", lineHeight: "20px", letterSpacing: "0.05em", fontWeight: 500, color: "#1c1c13", border: "1px solid rgba(193, 201, 190, 0.4)", backgroundColor: "transparent" }} onMouseEnter={(e) => { if (!loadingText) e.currentTarget.style.backgroundColor = "#f6f4e5"; }} onMouseLeave={(e) => { if (!loadingText) e.currentTarget.style.backgroundColor = "transparent"; }}>',
  ...
  '                  Google',
  '                </button>',
  '                <button type="button" disabled={!!loadingText} className="flex items-center justify-center gap-2 py-3 rounded-xl transition-colors disabled:opacity-50" style={{ fontFamily: "\'Plus Jakarta Sans\', sans-serif", fontSize: "14px", lineHeight: "20px", letterSpacing: "0.05em", fontWeight: 500, color: "#1c1c13", border: "1px solid rgba(193, 201, 190, 0.4)", backgroundColor: "transparent" }} onMouseEnter={(e) => { if (!loadingText) e.currentTarget.style.backgroundColor = "#f6f4e5"; }} onMouseLeave={(e) => { if (!loadingText) e.currentTarget.style.backgroundColor = "transparent"; }}>',
  ...
  '              <p style={{ fontFamily: "\'Plus Jakarta Sans\', sans-serif", fontSize: "16px", lineHeight: "24px", fontWeight: 400, color: "#424941" }}>',
  ...
  '            <a href="#" className="transition-colors" style={{ fontFamily: "\'Plus Jakarta Sans\', sans-serif", fontSize: "14px", lineHeight: "20px", letterSpacing: "0.05em", fontWeight: 500, color: "#424941" }}>Privacy Policy</a>',
  '            <a href="#" className="transition-colors" style={{ fontFamily: "\'Plus Jakarta Sans\', sans-serif", fontSize: "14px", lineHeight: "20px", letterSpacing: "0.05em", fontWeight: 500, color: "#424941" }}>Terms of Service</a>',
  '            <a href="#" className="transition-colors" style={{ fontFamily: "\'Plus Jakarta Sans\', sans-serif", fontSize: "14px", lineHeight: "20px", letterSpacing: "0.05em", fontWeight: 500, color: "#424941" }}>Support</a>',
  '          </footer>',
  '        </section>',
  '      </div>',
  '    </main>',
