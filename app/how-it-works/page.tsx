  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 overflow-hidden pb-24 selection:bg-orange-200 selection:text-orange-900">
      ...
      <section className="relative px-6 pt-12 pb-20 md:pt-20 md:pb-32 text-center max-w-5xl mx-auto flex flex-col items-center">
        ...
        <Reveal>
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white border border-orange-200 text-orange-600 text-xs font-black tracking-widest uppercase mb-8 shadow-sm">
      ...
      {/* TIMELINE SECTION */}
      <section className="max-w-6xl mx-auto px-6 relative z-10 py-12 md:py-20">
        
        <div className="relative">
          {/* The Continuous Vertical Glowing Line */}
          {/* Left-aligned on mobile, perfectly centered on desktop */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-1.5 bg-gradient-to-b from-orange-100 via-orange-400 to-orange-100 -translate-x-1/2 rounded-full z-0 opacity-60"></div>
          ...
          <div className="space-y-12 md:space-y-24 relative z-10">
            ...
            <TimelineStep 
              ...
              align="left"
              svgIcon={<svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>}
            />
            ...
            <TimelineStep 
              ...
              align="right"
              svgIcon={<svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>}
            />
            ...
            <TimelineStep 
              ...
              align="left"
              svgIcon={<svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" /></svg>}
            />
      ...
      <Reveal>
        <section className="px-6 mt-32 max-w-5xl mx-auto">
          <div className="bg-slate-900 rounded-[3rem] shadow-2xl p-12 md:p-20 text-center border border-slate-800 relative overflow-hidden">
            ...
            {/* Dark Mode Glows */}
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-orange-500/15 rounded-full blur-[100px] pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-orange-600/15 rounded-full blur-[80px] pointer-events-none"></div>
            
            <div className="relative z-10">
              <p className="inline-block bg-orange-500/10 text-orange-400 border border-orange-500/20 px-4 py-1.5 rounded-full font-black uppercase tracking-widest text-xs mb-6">
                Every Second Counts
              </p>
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-5">
                <a
                  ...
                  className="w-full sm:w-auto bg-orange-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-orange-600 transition-all duration-300 shadow-xl hover:shadow-orange-500/25 hover:-translate-y-1 flex justify-center items-center gap-3 group"
                >
                  <svg className="w-6 h-6 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
                  Download App
                </a>
                <Link
                  href="/volunteer-form"
                  className="w-full sm:w-auto bg-slate-800 border-2 border-slate-700 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-slate-700 hover:border-slate-600 transition-all duration-300 shadow-lg hover:-translate-y-1 flex justify-center items-center gap-3 group"
                >
  ...
  return (
    <Reveal>
      <div className={`relative flex flex-col md:flex-row items-center w-full group ${isLeft ? "md:flex-row" : "md:flex-row-reverse"}`}>
        ...
        <div className="absolute left-8 md:left-1/2 top-8 md:top-1/2 -translate-y-1/2 -translate-x-1/2 z-20 flex">
          <div className="w-12 h-12 md:w-16 md:h-16 bg-white border-[4px] md:border-[6px] border-orange-100 rounded-full flex items-center justify-center font-black text-lg md:text-2xl text-slate-300 group-hover:border-orange-500 group-hover:text-orange-500 group-hover:shadow-[0_0_30px_rgba(249,115,22,0.3)] transition-all duration-500 z-10 bg-clip-padding">
            {step}
          </div>
        </div>

        {/* CONTENT CARD */}
        {/* Mobile: Pushed to the right. Desktop: Half width depending on alignment */}
        <div className={`w-full md:w-1/2 relative z-10 pl-24 md:pl-0 ${isLeft ? "md:pr-16" : "md:pl-16"}`}>
          
          <div className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/40 border border-slate-100 group-hover:shadow-2xl group-hover:shadow-orange-500/5 group-hover:border-orange-200 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
            
            <div className="relative z-10 flex flex-col sm:flex-row gap-6 md:gap-8 items-start">
              {/* Icon Container */}
              <div className="w-16 h-16 shrink-0 rounded-2xl bg-gradient-to-br from-orange-50 to-orange-100 text-orange-500 flex items-center justify-center border border-orange-200 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500 shadow-sm">
                {svgIcon}
              </div>
