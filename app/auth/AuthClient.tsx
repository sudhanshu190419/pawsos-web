          ...
          <section className="flex-1 flex flex-col justify-center px-5 md:px-16 py-8 md:py-10" style={{ backgroundColor: "#ffffff" }}>
            <div className="w-full max-w-md mx-auto">
              ...
              <div className="mb-6 md:mb-8">
                <h1 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: isSignup ? "clamp(28px, 3.5vw, 32px)" : "clamp(32px, 4.5vw, 48px)", lineHeight: isSignup ? "clamp(36px, 1.2em, 40px)" : "clamp(40px, 1.2em, 56px)", letterSpacing: "-0.02em", fontWeight: 700, color: "#1c1c13" }}>{isSignup ? "Create Account" : "Login"}</h1>
                <p className="mt-1 md:mt-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "14px", lineHeight: "20px", fontWeight: 400, color: "#424941" }}>{isSignup ? "Join the community today." : "Please enter your credentials to access your account."}</p>
              </div>
            ...
            <div className="mt-6 md:mt-8 pb-4 md:pb-0 text-center">
              <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "15px", lineHeight: "22px", fontWeight: 400, color: "#424941" }}>
                ...
                <button onClick={() => { setIsSignup(!isSignup); setName(""); }} className="font-bold ml-1 hover:underline" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "14px", lineHeight: "20px", letterSpacing: "0.05em", fontWeight: 700, color: "#325b38" }}>{isSignup ? "Sign In" : "Sign Up"}</button>
              </p>
            </div>
          </div>
